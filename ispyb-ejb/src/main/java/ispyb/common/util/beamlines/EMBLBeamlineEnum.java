...
/**
 * This class represents a beamline at EMBL. 
...
public enum EMBLBeamlineEnum {
	...
	public static EMBLBeamlineEnum retrieveBeamlineWithName(String aName){
		for(EMBLBeamlineEnum b:EMBLBeamlineEnum.values()){
	...
	public static String retrieveDirectoryNameWithName(String aName){
		EMBLBeamlineEnum beamline = retrieveBeamlineWithName(aName);
		if(beamline != null){
	...
	public static String[] getBeamlineNames(){
		String[] list = new String[EMBLBeamlineEnum.values().length];
		int i=0;
		for(EMBLBeamlineEnum b:EMBLBeamlineEnum.values()){
